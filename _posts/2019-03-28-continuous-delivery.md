...
　　不妨先BrainStorming一下，看大家都能想到什么名词。
   ...
   ![](/assets/img/2019/cd-branstorming.png){: .img-medium}
...
自从在团队中引入这样的实践之后，Martin Fowler发现这种方法可以显著减少集成引起的问题，并可以加快团队合作软件开发的速度。
   ...
   ![](/assets/img/2019/continuous-integration.png){: .img-large}
...
比如，我们完成单元测试后，可以把代码部署到连接数据库的 Staging 环境中更多的测试。如果代码没有问题，可以继续手动部署到生产环境中。
   ...
   ![](/assets/img/2019/continuous-delivery.png){: .img-large}

### 3. 持续部署
　　持续部署则是在持续交付的基础上，把部署到生产环境的过程自动化。

   ![](/assets/img/2019/continuous-deployment.png){: .img-large}
...
### 2. Portal架构
　　一般而言，Portal长什么样子呢？
   ![](/assets/img/2019/cd-anchor2-portal1.png){: .img-large}

　　Portal的技术架构：
   ![](/assets/img/2019/cd-anchor2-portal2.png){: .img-large}
　　详细了解Portal，可以参考笔者之前的[Portal 和 Portlet](https://zhangyuyu.github.io//portal-portlet/)

　　该项目的实际架构：
   ![](/assets/img/2019/cd-anchor2-portal3.png){: .img-large}

### 3. Initial Workshop
　　为了挖掘客户的痛点，确定实际的需求，团队邀请相关的技术人员进行了一次Initial Workshop：
   ![](/assets/img/2019/cd-anchor2-initial-workshop.png){: .img-large}
...
### 5. 部署流水线
　　改进部署流程如下：
   ![](/assets/img/2019/cd-anchor2-pipeline.png){: .img-large}

　　改进框架及工具如下：
   ![](/assets/img/2019/cd-anchor2-tools.png){: .img-large}
...
　　配置管理是指一个过程，通过该过程，所有与项目相关的产物，以及它们之间的关系都被唯一定义、修改、存储和检索。主要包括：
   ...
   ![](/assets/img/2019/cd-anchor2-config-management1.png)

　　改进计划中，采用docker，确保`工具集配置`的一致性：
   ![](/assets/img/2019/cd-anchor2-config-management2.png){: .img-large}

　　改进计划中，采用openshift，确保`软件配置`的一致性：
   ![](/assets/img/2019/cd-anchor2-config-management3.png){: .img-large}
...
#### 5.3 部署
　　项目实际部署方式：
   ![](/assets/img/2019/cd-anchor2-deployment.png)
...
### 1. 传统的开发模式
　　开发过程
   ![](/assets/img/2019/cd-anchor3-traditional-develop-pattern1.png){: .img-large}

　　开发过程的循环方式：
   ![](/assets/img/2019/cd-anchor3-traditional-develop-pattern2.png){: .img-large}

　　中间所涉及到的痛点：
   ![](/assets/img/2019/cd-anchor3-traditional-develop-pattern3.png){: .img-large}

### 2. 持续集成的工作模式
　　开发过程：
   ![](/assets/img/2019/cd-anchor3-develop-pattern1.png){: .img-large}

　　开发过程中的循环方式：
   ![](/assets/img/2019/cd-anchor3-develop-pattern2.png){: .img-medium}
...
　　常见的Pipeline的Stage:
   ![](/assets/img/2019/continuous-delivery-pipeline1.png){: .img-large}

　　Go cd工具的流水线示例：
   ![](/assets/img/2019/continuous-delivery-pipeline2.png){: .img-large}

　　Jenkins工具的流水线示例：
   ![](/assets/img/2019/continuous-delivery-pipeline3.png){: .img-large}
...
### 3. 原则三：对所有内容进行版本控制
   ![](/assets/img/2019/continuous-delivery-7-steps-git-commit.png){: .img-large}

Note: 版本控制的时候，通常采用七步提交法
   ![](/assets/img/2019/continuous-delivery-version-everything.png)
...
　　团队应该统一定义`Done`的含义，开发完成和测试完成并不是真正意义的Done，只能算成是Completed。
   ![](/assets/img/2019/continuous-delivery-done-wall.png){: .img-large}

　　最好的做法，是每次上线前，在pre production环境有一次showcase，确保理解一致，确保用户验收，然后上线。
   ![](/assets/img/2019/continuous-delivery-showcase.png){: .img-large}

### 7. 原则七：交付过程是每个人的责任
   ![](/assets/img/2019/continuous-delivery-team.png){: .img-large}


### 7. 原则八：持续改进
　　每个迭代完成之后，需要一个retrospective回顾会议对上次的迭代进行回顾。继续做的好的，停止做的不好的，对一些改进措施分配具体的Action。
   {% capture images %}
        /assets/img/2019/continuous-delivery-retro1.png
        /assets/img/2019/continuous-delivery-retro2.png
   {% endcapture %}
...
　　一个最小化的持续集成系统需要包含以下几个要素：
   ...
   ![](/assets/img/2019/continuous-integration-factors.png)

### 2. 持续集成一般都包含哪些任务？
　　持续集成并不是说只要代码能编译通过就是集成成功，我们已经把每次集成都看做一次完整的测试。
　　任何迁入到代码库中的代码都应该是可以部署到产品环境的。
   ![](/assets/img/2019/continuous-integration-tasks.png)
...
### 4. 持续交付平台
   ![](/assets/img/2019/continuous-delivery-platform.png){: .img-large}

### 5. Pipeline阶段
   ![](/assets/img/2019/continuous-delivery-pipeline-stages.png)

### 6. 说到持续交付，你想到了什么
　　回顾最开始的"[说到持续持续交付，你想到了什么？](#anchor-0)"，对应到下面的图中的关键字。
   ![](/assets/img/2019/continuous-delivery-keyword.png)
