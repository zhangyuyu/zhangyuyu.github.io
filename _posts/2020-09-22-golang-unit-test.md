...
输入： 实数
输出： 实数
要求： 当输入一个0或者比0大的实数时，返回其正的平方根；当输入一个小于0的实数时，显示错误信息“平方根非法—输入之小于0”，并返回0；库函数`printf()`可以用来输出错误信息。 | 
...
![](/assets/img/2020/20200923-KM-日报.png)
...
## 5. KM头条
　　刚好请假没关注KM，只收到了邮件推送：
![](/assets/img/2020/20200923-KM-头条.png)
...
　　群里有截图，见证了一下：
![](/assets/img/2020/20200923-KM-Top1.png)
