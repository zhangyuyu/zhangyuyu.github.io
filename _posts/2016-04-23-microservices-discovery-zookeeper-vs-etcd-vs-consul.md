...
#### 2.3 对于etcd、Registrator和Confd组合的最后的思考
...
![](/assets/img/2016/consul-template.png)
　　
...
　　
>完整中文版地址:[服务发现：ZooKeeper vs etcd vs Consul](http://dockone.io/article/667)
